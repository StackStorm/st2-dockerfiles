...
build:
	...
	@echo -e "\033[32mSuccessfully built \033[1mstackstorm/st2base:${DOCKER_TAG}\033[0m\033[32m common Docker image with StackStorm version \033[1m${ST2_VERSION}\033[0m"
	@set -e; \
